...
# Ordem de fallback. GLM 5.2 escolhido no ADR 0002 (piloto da spec 004);
# os anteriores permanecem como fallback quando ele falha.
DEFAULT_MODELS = ["glm-5.2:cloud", "kimi-k2.6:cloud", "deepseek-v4-pro:cloud"]
DEFAULT_RPM = 60
