...
def find_join(graph: ProcessGraph, fork_id: str) -> str | None:
    ...
    best: str | None = None
    best_cost = float("inf")
    # `sorted` é obrigatório: em empate de custo vencia o primeiro da iteração do
    # set, cuja ordem depende do hash das strings e muda a cada processo. Isso
    # tornava a DSL emitida não determinística entre execuções.
