...
Por restrição de cronograma, essa etapa permanece tratada como trabalho futuro caso não seja concluída no prazo do TCC. Registra-se, contudo, que a análise acima altera sua posição relativa: de extensão opcional, passa a ser a intervenção de melhor relação entre custo e retorno esperado \textbf{caso o ajuste supervisionado não resolva a validade sintática}, à frente tanto da ampliação do corpus quanto de modificações no \textit{pipeline} de geração de dados.
