...
Os algoritmos de aprendizado de máquina que fazem classificação em imagens, necessitam que estas sejam de baixa dimensionalidade \cite{yang2019re} . \gls{KNN} askjdhkjasdhj ashdkajsdhajkhj \gls{KNN}

Tal modelo pode ser visualizado através da Figura \ref{fig:fluxogramaDeAlgumaCoisa}. 

\ref{fig:oficial}

\begin{figure}[h!]
    \centering
    \Caption{\label{fig:fluxogramaDeAlgumaCoisa} Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse commodo lectus et augue elementum varius.}	
    \UNIFORfig{}{
