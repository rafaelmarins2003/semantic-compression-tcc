...
\begin{simbolos} \itemsep -1pt
	...
	\item[$ \mathcal{R} $] Multiconjunto \textit{direct-follows} do modelo de referência
	\item[$ \mathcal{C} $] Multiconjunto \textit{direct-follows} do modelo candidato
	\item[$ P $] Precisão sobre o multiconjunto \textit{direct-follows}
	\item[$ R $] Revocação sobre o multiconjunto \textit{direct-follows}
